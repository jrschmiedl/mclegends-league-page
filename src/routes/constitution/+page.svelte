...
<div class="constitution">
    <h1 class="noUnderscore">MC LEGENDS DYNASTY CONSTITUTION</h1>
    ...
    <div class="subBlock">
        <p>The trade deadline will be set for Week 13. Trades must be accepted prior to the end of the final game of Week 13.</p>
    </div>
    ...
    <div class="subBlock">
        <p>A total of 7 veto votes are required to veto a trade. Vetoes are only appropriate in instances of collusion. Not liking a trade does not warrant a veto.</p>
    </div>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $200. $0 bids are allowed. Bids will process Thursdays and Sundays at 9AM EST.</p>
    ...
    <p>Rookie Draft Order is as Follows:</p>
    <ul>
        ...
        <li>X.10: Highest Overall Winning Percentage/Playoff Seed</li>
        <li>X.11: Runner Up</li>
    ...
    <p>The league scoring system breakdown is listed on the Sleeper fantasy app (for the most part, it follows .5 TEP PPR Scoring). The scoring system will never change without a majority league vote.</p>
    ...
    <ul>
        <li>1st place: {dues * 6.4}$</li>
        <li>2nd place: {dues * 1.85}$</li>
        <li>3rd place: {dues}$</li>
        <li>4th place: {dues * 0.75}$</li>
        <li>5th/6th place: {dues * 0.5}$</li>
        <li>Best Regular Season Record: {dues * 0.5}$</li>
        <li>Most Points Scored Regular Season: {dues * 0.5}$</li>
    </ul>
